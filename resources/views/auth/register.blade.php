                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <input placeholder="nikoru, erka21..."d="username" type="username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <input placeholder="user@email.com" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
