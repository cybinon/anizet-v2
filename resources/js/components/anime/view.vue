                ...
                <v-card class="mx-auto" tile>
                    ...
                    <v-list-item two-line>
                        <v-list-item-content>
                            ...
                            <v-list-item-subtitle
                                >Нийт гарсан анги:
                                {{ infos.videos.lenght }}</v-list-item-subtitle
                            >
                            <v-list-item-subtitle
                                >Нийт гарах анги:
                                {{ infos.episodes }}</v-list-item-subtitle
                            >
                        </v-list-item-content>
                    </v-list-item>
                    ...
                    <v-list-item :href="'/#/player/' + item.id">
                        <v-list-item-content>
                            <v-list-item-title class="orange--text"
                                >Анги:
                                {{ item.episode_number }}</v-list-item-title
                            >
                            <v-list-item-subtitle
                                v-text="item.episode_caption"
                            ></v-list-item-subtitle>
                            <v-divider></v-divider>
                        </v-list-item-content>
                    </v-list-item>
