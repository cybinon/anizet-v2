  ...
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app clipped>
      <v-list>
        ...
        <v-list-item class="nav-link" to="/team">
          <v-list-item-action>
            <v-icon small color="orange darken-2">fab fa-angellist</v-icon>
          </v-list-item-action>
          <v-list-item-content>
            <v-list-item-title>Гишүүд</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-divider></v-divider>
        <v-list-group color="orange darken-2" prepend-icon="fas fa-user" value="false">
          ...
          <v-list-item disabled class="nav-link" to="/mylist">
            ...
            <v-list-item-content>
              <v-list-item-title>Зохиол Жагсаалт</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        ...
        <v-list-item center class="nav-link">
          <v-list-item-action>
            <v-icon x-small color="orange darken-2">fas fa-moon</v-icon>
          </v-list-item-action>
          <v-list-item-content>
            <v-list-item-title>
              <v-switch v-model="switch1" color="orange darken-2"></v-switch>
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
